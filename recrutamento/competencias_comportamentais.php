<?php
//
//- competencias_comportamentais.php | R&S | Cadastro de Competências Comportamentais
//- (C)haia, 24/08/2026
//
...
$titulo_pagina = "COMPETÊNCIAS COMPORTAMENTAIS"; // Define o Título aqui
...
<main class="container py-4">
  ...
  <div class="d-flex justify-content-between align-items-center mb-4 pb-3 border-bottom border-secondary">
    <div class="d-flex align-items-center gap-3">
      ...
      <div>
        <h4 class="mb-0 text-white fw-bold">Competências Comportamentais</h4>
        <p class="text-white-50 small mb-0">Cadastro das competências comportamentais disponíveis na solicitação de vaga</p>
      </div>
    </div>
      ...
      <div class="modal-body">
        ...
        <form id="formCompetencia">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="descricao" id="competencia_descricao" class="form-control" maxlength="150" placeholder="Ex: Liderança de equipes" required>
          </div>
...
<script src="js/competencias_comportamentais.js"></script>

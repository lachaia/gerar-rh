//
// competencias_tecnicas.js | Rotinas do CRUD de Competências Técnicas | competencias_tecnicas.php
// (C)haia, 2026-08-24
//
...
function constroi_grid() {
    dataTable = new DataTable('#grid_competencias', {
        ...
        "ajax": {
            "url": "inc/competencias_tecnicas_aj.php",
            "type": "POST"
        },
        "columnDefs": [
            {
...
function editar_competencia(id) {
    $.ajax({
        url: 'inc/competencia_tecnica_get_aj.php',
        type: 'POST',
        dataType: 'json',
        data: { id: id },
...
function salvar_competencia() {
    ...
    const url = id ? 'inc/competencia_tecnica_alt_aj.php' : 'inc/competencia_tecnica_inc_aj.php';
...
function excluir_competencia(id) {
    ...
    $.ajax({
        url: 'inc/competencia_tecnica_exc_aj.php',
        type: 'POST',
        dataType: 'json',
        data: { id: id },
        success: function (res) {

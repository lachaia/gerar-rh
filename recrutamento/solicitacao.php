...
<main class="container py-4">
  ...
  <div class="d-flex justify-content-between align-items-center mb-4 pb-3 border-bottom border-secondary">
    <div class="d-flex align-items-center gap-3">
      <div class="icon-box bg-primary bg-opacity-10 text-primary border border-primary border-opacity-25">
        <img src="img/loginho.png" class='logomarca' alt="logomarcas">
    ...
    <div><?= '<i class="fa-solid fa-user"></i> ' . $_SESSION['nmLogin'] ?></div>
  </div>
  ...
  <form id="formSolicitacaoVaga" action="vaga_salvar.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="d-flex justify-content-end gap-2 mb-5">
      ...
      <button type="button" class="btn btn-primary px-4 fw-bold" onclick='enviar_solicitacao("solicitacao")'>
...
<script>
  window.solicitacaoVagaConfig = {
    successMessage: 'Solicitação enviada com sucesso. A vaga agora está aguardando autorização da superintendência.',
    successRedirect: 'logout.php'
  };
</script>
<script src="js/vaga_new.js?v=20260817_1"></script>
</body>
</html>

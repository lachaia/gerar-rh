<?php
//
//- competencia_tecnica_get_aj.php | Recupera 1 registro de rs_competencias_tecnicas para edição
//- (C)haia, 24/08/2026
//
...
$sql = "SELECT id, descricao, ativo FROM rs_competencias_tecnicas WHERE id = :id";

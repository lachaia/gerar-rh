<?php
//
//- candidato_origem_get_aj.php | Recupera 1 registro de rs_candidatos_origem para edição
//- (C)haia, 27/08/2026
//
...
$sql = "SELECT id, descricao, ativo FROM rs_candidatos_origem WHERE id = :id";

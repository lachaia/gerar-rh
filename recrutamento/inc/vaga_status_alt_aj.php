<?php
//
//- vaga_status_alt_aj.php | Altera registro existente em rs_vagas_status
//- (C)haia, 24/08/2026
//
...
if ($stmt->execute()) {
    ...
    echo json_encode(["status" => false, "msg" => "Falha ao atualizar status."]);
}
exit;

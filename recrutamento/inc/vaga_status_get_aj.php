<?php
//
//- vaga_status_get_aj.php | Recupera 1 registro de rs_vagas_status para edição
//- (C)haia, 24/08/2026
//
...
$sql = "SELECT id, status, descricao, ativo, cor_frente, cor_fundo FROM rs_vagas_status WHERE id = :id";

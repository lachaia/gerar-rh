<?php
//
//- competencia_tecnica_inc_aj.php | Inclui novo registro em rs_competencias_tecnicas
//- (C)haia, 24/08/2026
//
...
$sql = "INSERT INTO rs_competencias_tecnicas (descricao, ativo, login_id) VALUES (:descricao, :ativo, :login_id)";

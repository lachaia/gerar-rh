<?php
//
//- competencia_tecnica_alt_aj.php | Altera registro existente em rs_competencias_tecnicas
//- (C)haia, 24/08/2026
//
...
$sql = "UPDATE rs_competencias_tecnicas SET descricao = :descricao, ativo = :ativo WHERE id = :id";

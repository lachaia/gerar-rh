<?PHP
//
// aprova_aj.php | Salva APROVAÇÃO de Férias pelo SUPERVISOR
// (C)haia, 29/05/2025
//
...
/*
aprova_aj.php | 2025-05-29 15:18:49 
{
    "idFerias": "2",
    "idGestor": "11",
    "senha": "Gerar2025",
...
//
    ...
    if (!empty($parcelas_desmarcadas)) {
        ...
        $sql = "INSERT INTO rh_ferias_repro (idFerias, motivo, idColabSupervisor, criado_em) 
                    VALUES ( :idFerias, :motivo, :idGestor, :dataHora )";
        $stmt = $conn->prepare($sql);
        $stmt->bindParam(':idFerias', $idFerias, PDO::PARAM_INT);
        $stmt->bindParam(':motivo', $motivo, PDO::PARAM_STR);
        $stmt->bindParam(':idGestor', $idGestor, PDO::PARAM_INT);

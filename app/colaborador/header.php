...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <div class="d-grid">
            ...
            <button class="nav-btn <?= ($modulo == 'MeusDados') ? "active" : "" ?>" onclick='go("dados.php")'>
            ...
            <button class="nav-btn <?= ($modulo == 'Curriculo') ? "active" : "" ?>" onclick='go("curriculo.php")'>
                <i class="fa-solid fa-file-pen"></i> Currículo
            </button>

            <button class="nav-btn <?= ($modulo == 'Termos') ? "active" : "" ?>" onclick='go("termos.php")'>
...
<!--            <button class="nav-btn <?= ($modulo == 'Desempenho') ? "active" : "" ?>" onclick='go("desempenho.php")'>
                <i class="bi bi-bar-chart-fill"></i> Desempenho
            </button>
-->
            <button class="nav-btn <?= ($modulo == 'Equipamentos') ? "active" : "" ?>" onclick='go("equipamentos.php")'>
                <i class="fa-solid fa-computer"></i> Equipamentos
            </button>
            <?php 
            if ($_SESSION['BATE_PONTO'] == 1) { ?>
                <button class="nav-btn <?= ($modulo == 'Ponto') ? "active" : "" ?>" onclick='go("ponto.php")'>
                    <i class="fa-solid fa-clock"></i> Meu Ponto
                </button><?php
            }
            ?>

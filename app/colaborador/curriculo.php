<?PHP
//
// curriculo.php | Módulo de CURRÍCULO do Portal do Colaborador
// (C)haia, 15/10/2025
...
//
$sql = "SELECT C.idColab, C.data_admissao, CG.nome as dsCargo, F.nome as dsFuncao, 
            ...
            LEFT OUTER JOIN rh_pessoas P on P.idPessoa = C.idPessoa
...
if (! $registro) {
    $sql = "INSERT INTO rh_cv 
            (idEmpresa, idPessoa, data, ultimaAtualizacao) 
        VALUES 
            (:idEmpresa, :idPessoa, :data, :ultimaAtualizacao)";
    ...
    $stmt->bindParam(':data', $agora);
    $stmt->bindParam(':ultimaAtualizacao', $agora);
    // Executar a query
    $stmt->execute();
    $idCV = $conn->lastInsertId();
    //
    $sql = "SELECT * FROM rh_cv WHERE idCV = $idCV";
...
<main class="main">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            <h2 class="mb-0"> <i class="fa-solid fa-file-pen"></i> Currículo do Colaborador</h2>
            <small style="color:var(--muted)">Mantenha seu curriculo atualizado para aproveitar as oportunidades internas</small>
        </div>
    ...
    <div class="big-card">
        ...
        <div class='row'>
            ...
            <!-- PRIMEIRA COLUNA -->
            <div class='col-sm-6' data-bs-theme="dark">
                    ...
                    <div class="card-body container" style="font-size: 13px;">
                        <form id='formCV'>
                            ...
                            <div class="container mt-4">
                                ...
                                <!-- Bloco de Gênero -->
                                <div class="card bg-secondary shadow-sm p-3 rounded-3 border-0">
                                    <div class="row align-items-center">
                                        <label class="form-label fw-bold">
                                            <i class="fa-solid fa-venus-mars"></i> Gênero
                                        </label>
                                        <div class="col-sm-12">
                                ...
                                <div id="selectDeficiencia" class="card bg-secondary shadow-sm p-3 mt-3 rounded-3 border-0">
                                    <div class="form-check">
                                        <input
                                            ...
                                            <?= ($deficiente == '1') ? 'checked' : ''; ?>>
                                        <label class="form-check-label" for="deficiente"> Pessoa com deficiência?</label>
                                    </div>
                                </div>

                                <div id="deficiencia-bloco" class="card bg-secondary shadow-sm p-3 mt-3 rounded-3 border-0 collapse">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <div>
                                                <input class='form-check-input' type='checkbox' onclick='toggleNaoDeficiencia(this)' id='naoTenhoDeficiencia'>
                                                <label class="form-check-label" for="naoTenhoDeficiencia">Eu não tenho deficiência alguma!</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-2 border-start border-3 border-dark ps-3">
                                            <label class="form-label" for="cid">CID</label>
                                            <input class="form-control form-control-sm text-center" type="text" id="cid" name="cid" placeholder="Código CID" onChange='showBtnCV()' value="<?= $cid ?>">
                                        </div>
                                    </div>
                                </div>

                                <!-- Bloco LinkedIn -->
                                <div class="card bg-secondary shadow-sm p-3 mt-3 rounded-3 border-0">
                                    <label class="form-label fw-bold" for="linkedin">Perfil do LinkedIn</label>
                                    <input class="form-control" type="text" id="linkedin" name="linkedin" placeholder="Insira o link do seu perfil" value='<?= $linkedin ?>' onChange='showBtnCV()'>
                                </div>
                                <!-- Bloco UPLOAD  -->
                                <div class="card bg-secondary shadow-sm p-3 mt-3 rounded-3 border-0">
                                    <label class="form-label fw-bold" for="arquivo"><b>Opcional</b>: envie o arquivo do CV personalizado</label>
                                    <div class="input-group">
                                        <input class="form-control" type="file" id="cv_arquivo" name="cv_arquivo" accept=".pdf, .doc, .docx">
                                        <button type='button' class="btn btn-primary" onclick="envia_arquivoCV()">Enviar</button>
                                    </div>
                                    <div id="mensagemUpload" class="mt-2">
                                        <?php
                                        if (! empty($arquivo)) {
                                            echo '<i class="fa-regular fa-folder-open"></i> ' . "<b>Arquivo de CV: </b> $arquivo <a href='#' onclick='mostra_cv($idPessoa,\"$arquivo\")'><i class='fa-solid fa-magnifying-glass'></i></a>";
                                        }
                                        ?>
                            ...
                            <div class="row collapse" id='btnSalvaCV'>
                                <div class="col text-end">
                                    <button type="button" class="btn btn-outline-secondary px-4" onclick='btnResetBloco1()'><i class="fa-solid fa-recycle"></i> Reset</button>
                                    <button type="button" class="btn btn-outline-primary px-4" onclick='salvar_cv()'><i class="fa-solid fa-download"></i> Salvar</button>
                                </div>
                            </div>
                    ...
                    <div class="card-body container" style="font-size: 13px;">
                        <form name='formDiversidade' id='formDiversidade'>
                            ...
                            <div class="alert alert-success alert-dismissible">
                                ...
                                serão usadas em todos os processos que utilizem a solução de Diversidade. Nenhum dado será utilizado como critério de
                                eliminação em futuras seleções.
                            </div>
                            <div class="row">
                                <div class="col-sm-4">
                                    <label for="cidade">Local de Origem</label>
                                    <div class="input-group">
                                        <input type="text" id="d_cidade" name="d_cidade" class='form-control' placeholder="Digite o nome da cidade" onchange='troggle_on_btn_diversidade()'>
                                    ...
                                    <input type="hidden" id="d_cidade_id" name="d_cidade_id">
                                </div>
                                <div class="col-sm-4">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-sm-4">
                                    <div class="col text-end mt-3 collapse" id='btnDiversidade'>
                                        <button type="button" class="btn btn-outline-secondary px-4" onclick='btnResetDiversidade()'><i class="fa-solid fa-recycle"></i> Reset</button>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content" style="background-color: gainsboro">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="btn-group">
                            <button type="button" class="btn btn-outline-primary btn-sm rounded m-1"

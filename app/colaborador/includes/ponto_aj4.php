<?PHP
//
//- ponto_aj4.php | (C)haia, 09/12/2025 | Formulário Alterar uma Batida
//
...
//
    ...
    ?>
      ...
      <!-- Header -->
    <h5 class="text-center h5" id="">Alterar Registro-Ponto</h5>

      <!-- Body -->
      <div class="">
        <form id="formBatida">
          <input type="hidden" id="batidaId" name="batidaId" value='<?= $id ?>'>
          <input type="hidden" id="tipoSolicitacao" name="tipoSolicitacao" value='ALT'>
      ...
      <div class="d-flex justify-content-center" id="divBotoesFormulario">
        ...
        <button type="button" class="btn btn-primary w-100 m-1" onclick="f_salvar_alteracao()">Salvar</button>
      </div>

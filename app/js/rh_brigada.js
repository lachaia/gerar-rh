...
function constroiTabelaMembros() {
    ...
    dataTableMembros = new DataTable('#tabMembros', {
        ...
        "ajax": {
            "url": "brigada/rh_brigada_aj1.php",
            "type": "POST"
        },
        "columnDefs": [{
            "targets": [0, 3, 4, 5],
...
function btnIncSalvarPessoa() {
    ...
    $.post("brigada/rh_brigada_aj2.php",
        {
...
function f_excluir(idMembro) {
    if (confirm("Confirma a Exclusão do Membro " + idMembro + " ?") == true) {
        $.post("brigada/rh_brigada_aj4.php", { id: idMembro },
...
function f_ver(id) {
    $.post("brigada/rh_brigada_aj5.php", { id: id }, function (retorno) {
        // alert(retorno);
...
function f_editar($idMembro) {
    ...
    //
    $.post("brigada/rh_brigada_aj5.php", { id: $idMembro }, function (retorno) {
        const x = JSON.parse(retorno);
        //
...
function constroiTabelaAtendimentos() {
    ...
    dataTableAtend = new DataTable('#tabAtendimentos', {
        ...
        "pageLength": linhasPorPagina, // Define a quantidade de linhas
        "ajax": {
            "url": "brigada/rh_brigada_aj8.php",
            "type": "POST"
        },
        "columnDefs": [
            {
...
function btnSalvarTipo() {
    ...
    $.post("brigada/rh_brigada_aj7.php", { descricao: descricao }, function (res) {
        alert(res.msg);
        if (res.status) {
...
function btnSalvarAtendimento() {
    ...
    $.post("brigada/rh_brigada_aj9.php",
        {
...
function f_ver_atende(id) {
    $.post("brigada/rh_brigada_aj10.php", { id: id }, function (retorno) {
        const x = JSON.parse(retorno);
        //
...
function btnSalvarAltAtendimento() {
    ...
    //
    mensagem.html('Aguarde, salvando os dados...');
    $.post("brigada/rh_brigada_aj11.php",
        {
            idMembro: idMembro.val(),
...
function f_excluir_atende(id) {
    if (confirm("Confirma a Exclusão do Atendimento: " + id + " ?") == true) {
        $.post("brigada/rh_brigada_aj12.php", { id: id },
            function (retorno, status) {
                const dados = JSON.parse(retorno);
...
function constroiTabelaReunioes() {
    ...
    dataTableReunioes = new DataTable('#tabReunioes', {
        ...
        "pageLength": linhasPorPagina, // Define a quantidade de linhas
        "ajax": {
            "url": "brigada/rh_brigada_aj13.php",
            "type": "POST"
        },
        "columnDefs": [
            {
...
function addTodosBrigadista(formName = "#formIncReuniao") {
    $.ajax({
        url: "brigada/rh_brigada_aj14.php",
        method: "POST",
        dataType: "json",
...
function btnSalvarReuniao(e) {
    ...
    //
    $.ajax({
        url: "brigada/rh_brigada_aj15.php",
        type: "POST",
        data: formData,
        dataType: "json",
...
function f_excluir_reuniao(id) {
    if (confirm("Confirma a Exclusão da Reunião: " + id + " ?") == true) {
        $.post("brigada/rh_brigada_aj16.php", { id: id },
            function (retorno, status) {
                const dados = JSON.parse(retorno);
...
function f_ver_reuniao(id) {
    $.post("brigada/rh_brigada_aj17.php", { id: id }, function (retorno) {
        const x = JSON.parse(retorno);
        //
...
function btnSalvarAltReuniao(e) {
    ...
    $.ajax({
        url: "brigada/rh_brigada_aj18.php",
        type: "POST",
        data: formData,
        dataType: "json",
        processData: false,
...
function constroiTabelaAcoes() {
    ...
    dataTableAcoes = new DataTable('#tabAcoes', {
        ...
        "pageLength": linhasPorPagina, // Define a quantidade de linhas
        "ajax": {
            "url": "brigada/rh_brigada_aj19.php",
            "type": "POST"
        },
        "columnDefs": [
            {
...
function btnSalvarAcao(){
    ...
    //
    $.ajax({
        url: "brigada/rh_brigada_aj20.php",
        type: "POST",
        data: formData,
        dataType: "json",
        processData: false, // necessário para envio de arquivos
...
function f_ver_acao(id){
    $.post("brigada/rh_brigada_aj21.php", { id: id }, function (retorno) {
        const x = JSON.parse(retorno);
        //
...
function btnSalvarAltAcao() {
    ...
    $.ajax({
        url: "brigada/rh_brigada_aj22.php",
        type: "POST",
        data: formData,
        dataType: "json",
        processData: false,
...
function f_excluir_acao(id){
    ...
    if (confirm("Confirma a Exclusão da Ação de Brigada ID: " + id + " ?") == true) {
        $.post("brigada/rh_brigada_aj23.php", { id: id },
            function (retorno, status) {
                const dados = JSON.parse(retorno);

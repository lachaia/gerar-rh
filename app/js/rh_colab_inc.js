...
function f_incluir_commit(){
    ...
    let idOrgao   = $("#idOrgao"  );
    let idSubSede = $("#idSubSede"  );
    let idPolo    = $("#idPolo"  );
    let idCargo   = $("#idCargo"  ); 
    let idFuncao  = $("#idFuncao" );
    let idCentroCusto = $("#idCentroCusto");
    ...
    */
    ...
    if (idSubSede.val() == 0) {
        alert("Informe uma SubSede!");
        idSubSede.focus();
        return false;
    }
    if (idPolo.val() == 0) {
        alert("Informe um Polo!");
        idPolo.focus();
        return false;
    }
...
function marquei_lider(checkbox) {
    ...
    $.post("includes/rh_colab_aj5.php", { idOrgao }, function (res) {
        try {
            ...
            if (dados.nivel == 6 || dados.staff == 1) {
...
function f_add_dependente_commit(){
    //
    let botoes         = $("#formDependente #botoesModalDependentes");
    let mensagem       = $("#formDependente #msgDependentes");
    let idPessoaDep    = $("#formDependente #idPessoaDep");
    let nmPessoaDep    = $("#formDependente #nmDependente");
    let idParentesco   = $("#formDependente #idParentesco");
    let dataNascimento = $("#formDependente #dataNascimento");
    let cpf            = $("#formDependente #cpf");
    //

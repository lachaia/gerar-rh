<?php
//
//- rh_ficha_colab.php | exibe Ficha do Colaborador
//- (C)haia, 07/03/2025
//
...
if (in_array($idStatus, [1, 2, 3])) {
    $dsStatus = "<span class='badge bg-success'>$dsStatus</span>";
} elseif (in_array($idStatus, [4, 5, 6, 12])) {
    $dsStatus = "<span class='badge bg-warning text-dark'>$dsStatus</span>";
} elseif (in_array($idStatus, [7, 8, 9])) {
    $dsStatus = "<span class='badge bg-danger'>$dsStatus</span>";
} elseif (in_array($idStatus, [10, 11])) {
    $dsStatus = "<span class='badge bg-primary'>$dsStatus</span>";
} elseif ($idStatus == 13) {
    $dsStatus = "<span class='badge bg-purple'>$dsStatus</span>"; // Você pode definir a classe `bg-purple` no CSS
}

if (empty($nome_mae)) $nome_mae = "Não Informado";
if (empty($dsGrauInstrucao)) $dsGrauInstrucao = "Não Informado";
if (empty($nmBanco)) $nmBanco = "Não Informado";
?>
<!DOCTYPE html>
<html lang="pt-br">
...
<head>
    ...
    <link href="css/rh_ficha_colab.css" rel="stylesheet" />
...
<body class="sb-nav-fixed">
                ...
                <div class="card">
                    <div class="card-header bg-dark text-light mt-1 mb-1 clearfix">
                        <div class="float-start">
                            <h4 class="card-title">
                                <i class="fa-regular fa-address-book"></i>&nbsp;<span id='idTipoFormulario'>COLABORADORES</span>
                            </h4>
                        </div>
                        <div class="float-end">
                            <a href='rh_colab.php' class="btn btn-outline-light btn-sm"><i class="fa-solid fa-arrow-left"></i>&nbsp;Voltar</a>
                        </div>
                    </div>
                </div>
                <div class='row'>
                            ...
                            <div class="card-body bg-light p-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <p class="campo-destaque"><?= htmlspecialchars($dsEstadoCivil) ?: 'Não informado' ?></p>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                    ...
                                    <div class="col-md-3 mb-1">
                                        ...
                                        <p class="campo-destaque"><?= htmlspecialchars($dsEtnia) ?: 'Não informado' ?></p>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <strong><i class="fa-solid fa-person-dress"></i> Nome da Mãe:</strong>
                                        <p class="campo-destaque"><?= htmlspecialchars($nome_mae) ?: 'Não informado' ?></p>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <strong><i class="fa-solid fa-graduation-cap"></i> Escolaridade:</strong>
                                        <p class="campo-destaque"><?= htmlspecialchars($dsGrauInstrucao) ?: 'Não informado' ?></p>
                                    </div>
                                    <div class="col-md-9 mb-1 text-center">
                            ...
                            <div class="card-body bg-light p-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <p class="campo-destaque"><?= $pis ?: 'Não informado' ?></p>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <p class="campo-destaque"><?= htmlspecialchars($nmBanco) ?: 'Não informado' ?></p>
                                    </div>
                                    <div class="col-md-2 mb-3">
                                        <strong><i class="fa-solid fa-building-columns"></i> Agência:</strong>
                                        <p class="campo-destaque"><?= htmlspecialchars($bco_agencia) ?: 'Não informado' ?></p>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <strong><i class="fa-solid fa-building-columns"></i> Conta Corrente:</strong>
                                        <p class="campo-destaque"><?= htmlspecialchars($bco_cc) ?: 'Não informado' ?></p>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <strong><i class="fa-solid fa-suitcase-medical"></i> Plano Farmácia :</strong>
                                        <p class="campo-destaque"><?= empty($planoFarmacia) ? "Nenhum" : $planoFarmacia ?></p>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <strong><i class="fa-regular fa-id-card"></i> CBO :</strong>
                                        <p class="campo-destaque"><?= empty($cbo) ? "Nenhum" : $cbo ?></p>
                                    </div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <strong><i class="fa-solid fa-comments-dollar"></i> PIX :</strong>
                                        <p class="campo-destaque"><?= empty($chave_pix) ? "ND" : htmlspecialchars($chave_pix) ?></p>
                                    </div>
                    ...
                    <div class='col-sm-5'>
                        ...
                        <div class="card mt-2">
                            <div class="card-header text-white cartao clear-fix">
                                <h5 class='text-start'><i class="fa-regular fa-hourglass"></i>&nbsp;Evolução dos Cargos</h5>
                            </div>
                            <div class="card-body container" style="font-size: 13px;">
                                <?php
                                $sql = "SELECT H.*, C.nome as nmCargo 
                                            FROM rh_historico_cargo H
                                            INNER JOIN rh_cargos C on C.idCargo = H.idCargo
                                        WHERE H.idColab = :idColab ORDER BY data";
                                $stmt = $conn->prepare($sql);
                                $stmt->bindParam(':idColab', $idColab, PDO::PARAM_STR);
                                $stmt->execute();
                                ?>
                                <table class="table w-100">
                                    ...
                                    <tbody>
                                        ...
                                        while ($linha = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                            extract($linha);
                                            $nmCargo = strip_tags($nmCargo);
                                            $motivo = strip_tags($motivo);
                                            //
                                            $icone = '<i class="fa-regular fa-circle-down"></i>';
                                            //
                                            echo "<tr>
                                            <td>$icone</td>
                                            <td>$data</td>
                        ...
                        <!-- EVOLUCAO DAS FUNÇÕES -->
                        <div class="card mt-2">
                            <div class="card-header text-white cartao clear-fix">
                                <h5 class='text-start'><i class="fa-regular fa-hourglass"></i>&nbsp;Evolução das Funções</h5>
                            </div>
                            <div class="card-body container" style="font-size: 13px;">
                                <?php
                                $sql = "SELECT H.*, F.nome as nmFuncao
                                        FROM rh_historico_funcao H
                                        INNER JOIN rh_funcoes F on F.idFuncao = H.idFuncao
                                        WHERE H.idColab = :idColab ORDER BY data";
                                $stmt = $conn->prepare($sql);
                                $stmt->bindParam(':idColab', $idColab, PDO::PARAM_STR);
                                $stmt->execute();
                        ...
                        <!-- EVOLUCAO NO ORGANOGRAMA -->
                        <div class="card mt-2">
                            <div class="card-header text-white cartao clear-fix">
                                <h5 class='text-start'><i class="fa-regular fa-hourglass"></i>&nbsp;Evolução no Orgranograma</h5>
                            </div>
                            <div class="card-body container" style="font-size: 13px;">
                                <?php
                                $sql = "SELECT H.*, O.descricao as dsOrgao
                                        FROM RH.rh_historico_orgao H
                                        INNER JOIN rh_organograma O on O.idOrgao = H.idOrgao
                                        WHERE H.idColab = :idColab ORDER BY data";
                                $stmt = $conn->prepare($sql);
                                $stmt->bindParam(':idColab', $idColab, PDO::PARAM_STR);
                                $stmt->execute();
                        ...
                        <!-- EVOLUCAO DOS SALÁRIOS -->
                        <div class="card mt-2">
                            <div class="card-header text-white cartao clear-fix">
                                <h5 class='text-start'><i class="fa-regular fa-hourglass"></i>&nbsp;Evolução dos Salários</h5>
                            </div>
                            <div class="card-body container" style="font-size: 13px;">
                                <?php
                                $sql = "SELECT H.*
                                        FROM rh_historico_sal H
                                        WHERE H.idColab = :idColab 
                                        ORDER BY data, valor";
                                $stmt = $conn->prepare($sql);
                                $stmt->bindParam(':idColab', $idColab, PDO::PARAM_STR);
                                $stmt->execute();
    ...
    <script src="js/rh_ficha_colab.js"></script>
</body>

<?PHP
//
// rh_ferias_aj5.php | Salva APROVAÇÃO de Férias pelo RH
// (C)haia, 30/09/2025
//
...
$login = isset($_SESSION['nmLogin']) ? $_SESSION['nmLogin'] : '';
...
/*
 rh_ferias_aj5.php | 2025-09-30 11:24:03 
{
    "idFerias": "2",
    "parcelas": "1",
    "parcelas_desmarcadas": "2",
    "motivoNaoAprovacao": "teremos que rever essa solicita\u00e7\u00e3o"
}
*/
//die();
...
if (in_array(1, $parcelas)) {
    $campos[] = "aprova_rh_1_por = '$login'";
    $campos[] = "aprova_rh_1_em = '$agora'";
}

if (in_array(2, $parcelas)) {
    $campos[] = "aprova_rh_2_por = '$login'";
    $campos[] = "aprova_rh_2_em = '$agora'";
}

if (in_array(3, $parcelas)) {
    $campos[] = "aprova_rh_3_por = '$login'";
    $campos[] = "aprova_rh_3_em = '$agora'";
}
...
if (!empty($parcelas_desmarcadas)) {
    foreach ($parcelas_desmarcadas as $p) {
        ...
        // Exemplo: zerar os campos da parcela desmarcada (Agenda + Gestor)
...
if (!empty($campos)) {
    ...
    $html = "<h3>Agendamento de Férias</h3>
        ...
        informamos que o RH aprovou a(s) seguinte(s) parcela(s) de férias: <strong>$textoParcelas</strong>.</p>";
    if (!empty($parcelas_desmarcadas)) {

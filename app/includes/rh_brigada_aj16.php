<?PHP
//
// rh_brigada_aj16.php | Exclui Registro de REUNIÃO de Brigada
// (C)haia, 26/06/2025
//
...
$conn = null;
die;
 rh_brigada_aj16.php | 2025-06-26 15:11:46 
{
    "id": "1"
}
*/
...
f_log("EXC", "EXCLUSÃO de REUNIÃO de Brigada, ID: $id | Dados Excluídos( $stringDados )", "rh_brigada_reunioes", $idModulo, $id);

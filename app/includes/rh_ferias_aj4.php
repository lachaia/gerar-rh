<?php
// rh_ferias_aj4.php | Monta Grid para Aprovação de Férias pelo RH
// by (C)haia, 29/09/2025
//
...
$periodo_aquisitivo = "de " . date('d/m/Y', strtotime($inicio_aquisitivo)) . " a " . date('d/m/Y', strtotime($fim_aquisitivo));
...
$html = '
        <div class="card p-4" style="background-color: #d8dbddff; border-radius: 12px; box-shadow: 0 0 20px rgba(0,0,0,0.6);">
            ...
            <div id="dadosFerias" class="text-center">
                ...
                <p><strong>Período Aquisitivo: </strong> '.$periodo_aquisitivo .'</p>
                <p><strong>Período Concessivo: </strong> '.$periodo_concessivo .'</p>
                <p><strong>Aprovado por: </strong> '.$_SESSION['nmLogin'] .'</p>
                <hr>';

                $parcelas = [];
                $html .= "<h5>Agendamento</h5>";
                $html .= "<table class='table table-sm table-bordered table-striped table-hover mx-auto text-center tabela-branca 
                ...
                // Parcela 1
                if (!empty($agenda_parte1) && !empty($dias_parte1) && empty($data_parte1) && !empty($aprova_1_por) && empty($aprova_rh_1_por)) {
                ...
                // Parcela 2
                if (!empty($agenda_parte2) && !empty($dias_parte2) && empty($data_parte2) && !empty($aprova_2_por) && empty($aprova_rh_2_por)) {
                ...
                // Parcela 3
                if (!empty($agenda_parte3) && !empty($dias_parte3) && empty($data_parte3) && !empty($aprova_3_por) && empty($aprova_rh_3_por)) {

<?php
//
//- rh_cargo_aj3.php | EXCLUIR Registro do Cargo
//- (C)haia, 21/03/2025
//
...
$sql = "DELETE FROM rh_cargos WHERE idCargo = $id";
$stmt = $conn->prepare($sql);
...
f_log("EXC", "EXCLUSÃO de Cargo no Sistema, ID: $id | Dados( $stringDados )", "rh_cargos", $idModulo, $id);

<?php
//
//- rh_autocadastro_aj3.php | EXCLUIR Registro do AUTOCADASTRO
//- (C)haia, 27/10/2025
//
...
$sql = "SELECT * FROM rh_autocadastro_ctr WHERE id = :id";
...
$sql = "DELETE FROM rh_autocadastro_ctr WHERE id = $id";
$stmt = $conn->prepare($sql);
...
f_log("EXC", "EXCLUSÃO de Autocadastro no Sistema, ID: $id | Dados( $stringDados )", "rh_autocadastro_ctr", $idModulo, $id);

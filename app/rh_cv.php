<?PHP
//
// - rh_cv.php | Formulário de cadastro de CURRICULUM VITAE
// (C)haia, 24/02/2025
                ...
                <div class="card">
                    <div class="card-header bg-dark text-light mt-1 mb-1 clearfix">
                        <div class="float-start">
                            <h4 class="card-title"><i class="fa-solid fa-user-tie"></i>&nbsp;<span
                                    id='idTipoFormulario'>CURRICULUM: <?= $nome ?></span></h4>
                        </div>
                        <div class="float-end">
                            <button type="button" class="btn btn-outline-light btn-sm" onClick="f_voltar()"><i
                                        ...
                                        <div id="deficiencia-bloco" class="card bg-light shadow-sm p-3 mt-3 rounded-3 border-0 collapse">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-sm-2 border-start border-3 border-dark ps-3">
                                                    ...
                                                    <input class="form-control" type="text" id="cid" name="cid" placeholder="Código CID" onChange='showBtnCV()' value="<?= $cid ?>">
                                                </div>
                                            </div>
                                        </div>

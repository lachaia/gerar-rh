...
<head>
    ...
    <link href="css/rh_funcoes.css" rel="stylesheet" />
...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            ...
            <main>
                <div class="container-fluid px-4">
                    <div class="card mt-2 bg-dark text-white">
                        <h3 class="m-4">
                            <i class="fa-solid fa-sitemap"></i> FUNÇÕES
                        </h3>
                    </div>
                    <div id='divAlertaFuncao' class="text-center invisivel"></div>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="example" class="table table-striped table-hover table-bordered table-sm fb-8 nowrap" style="width:100%">
                                <thead class="gb-gray">
                                    <tr>
                                        <th><sup>0</sup>ID</th>
                                        <th><sup>1</sup>Função</th>
                                        <th><sup>2</sup>Descrição</th>
                                        <th><sup>3</sup>Qtd</th>
                                        <th><sup>4</sup>ativo</th>
            ...
            <!-- The Modal INCLUIR FUNÇÃO -->
            <div class="modal fade" id="modalIncluir" tabindex="-1" aria-labelledby="incluirFuncaoLabel" aria-hidden="true" data-bs-backdrop="static">
                    ...
                    <div class="modal-content" style="background-color: gainsboro">
                        ...
                        <div class="modal-header" style='background-color: #C8C8C8 '>
                            <h4 class="modal-title">
                                <h5><i class="fa-solid fa-plus"></i> Incluir Função</h5>
                            </h4>
                        ...
                        <form id="formIncluir">
                            <div class="modal-body">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-12">
                                        <label for="_nome" class="col-sm-3 col-form-label">Nome da Função</label>
                                        <input type="text" class="form-control" id="_nome" name="_nome" placeholder="Digite o nome da função">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-12">
                                        ...
                                        <textarea class="form-control" id="_descricao" name="_descricao" rows="4" placeholder="Digite a descrição da função"></textarea>
                                    </div>
                                </div>
            ...
            <!-- The Modal EDITAR FUNÇÃO -->
            <div class="modal fade" id="modalEditar" tabindex="-1" aria-labelledby="editarFuncaoLabel" aria-hidden="true" data-bs-backdrop="static">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content" style="background-color: gainsboro">
                        <!-- Modal Header -->
                        <div class="modal-header" style='background-color: #C8C8C8 '>
                            <h4 class="modal-title">
                                <h5><i class="fa-regular fa-pen-to-square"></i> Alterar Função</h5>
                            </h4>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                        </div>
                        <!-- Modal body -->
                        ...
                        <form id="formEditar">
                            <input type="hidden" id="e_idFuncao" name="e_idFuncao">
                            <div class="modal-body">

                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <label for="_nome" class="col-sm-3 col-form-label">Nome da função</label>
                                        <input type="text" class="form-control" id="e_nome" name="e_nome" placeholder="Digite o nome da função">
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-12">
                                        <label for="_descricao" class="col-form-label">Descrição</label>
                                        <textarea class="form-control" id="e_descricao" name="e_descricao" rows="4" placeholder="Digite a descrição da função"></textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">
            ...
            <!-- The Modal VISUALIZAR FUNÇÃO -->
            <div class="modal fade" id="modalVisualizar" tabindex="-1" aria-labelledby="visualizarFuncaoLabel" aria-hidden="true" data-bs-backdrop="static">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content" style="background-color: gainsboro">
                        <!-- Modal Header -->
                        <div class="modal-header">
                            <h4 class="modal-title">
                                <h5><i class="fa-solid fa-eye"></i> Visualizar Função</h5>
                            </h4>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                        </div>
                        <!-- Modal body -->
                        <div class="modal-body">
                            <div class="row mb-3">
                                <div class="col-sm-10">
                                    <label class="col-sm-3 col-form-label">Nome da função</label>
    ...
    <script src="js/rh_funcoes.js"></script>
</body>

<?php
//
// - rh_subsedes.php | Grid: SubSedes
// - (C) Chaia, 25/07/2026 Sáb
//

$idModulo = 23; // SubSedes
...
if (!isset($_SESSION['idLogin'])) {
    ...
    f_log("CON", "Consulta grade de SubSedes da Gerar", "rh_subsedes", $idModulo, 0);
}
...
<head>
    ...
    <meta name="description" content="Tabela de SubSedes da Gerar" />
    <meta name="author" content="LAChaia" />
    <title>GERAR | SubSedes</title>
    ...
    <link rel="stylesheet" href="css/rh_subsedes.css" />
...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mt-2 bg-dark text-white">
                        <h3 class="m-4">
                            <i class="fa-solid fa-building"></i> SUBSEDES
                        </h3>
                    </div>
                    ...
                    <div class="card shadow-lg border-0 mb-4 mt-1">
                        <div class="card-header clearfix">
                            ...
                            <div class="float-end ms-2 me-2" id='seletores'>
                                <button class="btn btn-outline-primary btn-sm" onClick="f_incluir()"><i class="fa-solid fa-building-columns"></i> Incluir SubSede</button>
                            </div>
                        </div>
            ...
            <!-- Modal de inclusão de nova SubSede -->
            <div class="modal fade" id="modalIncSubSede" data-bs-backdrop="static" tabindex="-1" aria-labelledby="modalIncSubSedeLabel" aria-hidden="true">
                <div class="modal-dialog modal-xl">
                    <div class="modal-content bg-dark text-white border-secondary">
                        <div class="modal-header border-secondary">
                            <h5 class="modal-title" id="modalIncSubSedeLabel"><i class="fa-solid fa-building-columns me-2"></i>Incluir Nova SubSede</h5>
                            ...
                            <form id="form-inc">
                                <div class="row g-2">
                                    <div class="col-md-5">
                                        ...
                                        <input type="text" name="identificador" id="identificador" class="form-control bg-dark text-white border-secondary text-center" placeholder="Nome da SubSede" required onblur="maiusculas(this)">
                                    </div>

                                    <div class="col-md-2">
                                        <label class="form-label">ID *</label>
                                        <input type="text" name="subsede_id" id="subsede_id" class="form-control bg-dark text-white border-secondary" placeholder="ID da SubSede" required onblur="maiusculas(this)">
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <input type="text" id="busca_cidade" class="form-control bg-dark text-white border-secondary" placeholder="Comece a digitar o nome da cidade...">
                        ...
                        <div class="modal-footer border-secondary">
                            ...
                            <button type="button" class="btn btn-success" onclick="f_salvar_SubSede()">Salvar SubSede</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Modal de ALTERAÇÃO de SubSede -->
            <div class="modal fade" id="modalAltSubSede" data-bs-backdrop="static" tabindex="-1" aria-labelledby="modalAltSubSedeLabel" aria-hidden="true">
                <div class="modal-dialog modal-xl">
                    <div class="modal-content bg-dark text-white border-secondary">
                        <div class="modal-header border-secondary">
                            <h5 class="modal-title" id="modalAltSubSedeLabel"><i class="fa-solid fa-building-columns me-2"></i>Editar SubSede</h5>
                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form id="form-alt">
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-2">
                                        <label class="form-label">ID *</label>
                                        <input type="text" name="subsede_id" id="subsede_id" class="form-control bg-dark text-white border-secondary" placeholder="ID da SubSede" required>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="form-check form-switch mt-1">
                                            <input class="form-check-input custom-switch" type="checkbox" name="ativo" id="ativo" value="1" checked>
                                            <label class="form-check-label text-white-50" for="ativo" id="lbl_ativo">Sim</label>
                                        </div>
                                    </div>
                        ...
                        <div class="modal-footer border-secondary">
                            <button type="button" class="btn btn-outline-light" data-bs-dismiss="modal">Cancelar</button>
                            <button type="button" class="btn btn-success" onclick="f_salvar_alteracao()">Salvar SubSede</button>
                        </div>
                    </div>
                </div>
            </div>

            <!-- Modal de VISUALIZAÇÃO de SubSede -->
            <div class="modal fade" id="modalVisSubSede" tabindex="-1" aria-labelledby="modalVisSubSedeLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content bg-dark text-white border-info">
                        <div class="modal-header border-info">
                            <h5 class="modal-title" id="modalVisSubSedeLabel"><i class="fas fa-id-card me-2"></i> SubSede</h5>
                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-8">
                                    <label class="text-info small fw-bold">Identificação</label>
                                    <div id="v_nome" class="p-2 border-bottom border-secondary text-uppercase"></div>
                                </div>
                                <div class="col-md-4">
                                    <label class="text-info small fw-bold">ID SubSede</label>
                                    <div id="v_id" class="p-2 border-bottom border-secondary"></div>
                                </div>
    ...
    <script data-cfasync="false" src="js/rh_subsedes.js"></script>

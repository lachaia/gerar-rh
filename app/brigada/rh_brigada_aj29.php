<?PHP
//
// rh_brigada_aj29.php | Exclui Registro de DOCUMENTO
// (C)haia, 22/07/2025
//
...
//
    if( !empty( $dados['arquivo'] ))
    {
        ...
        $caminhoArquivo = "../docs/brigada/" . basename($arquivo);
        if (file_exists($caminhoArquivo)) {
            unlink($caminhoArquivo); // Exclui o arquivo do servidor
        }
    }

f_log("EXC", "EXCLUSÃO de DOCUMENTO de Brigada, ID: $id | Dados Excluídos( $stringDados )", "rh_documentos", $idModulo, $id);

            ...
            <div id='divCabecalho' class="card mt-4 bg-dark text-white d-flex flex-row justify-content-between align-items-center px-3 w-100">
                ...
                <div class="d-flex align-items-center">
                    <h3 class="m-3 text-nowrap">
                        <i class="fa-solid fa-fire-extinguisher text-danger"></i> BRIGADA
                    </h3>
                    ...
                    <div class="tab-content">
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <div class='clearfix'>
                                            ...
                                            <div class="float-end">
                                                <button class="btn btn-sm btn-outline-primary m-2" onclick='btn_incluir_membro()'><i class="fa-solid fa-user-plus me-1"></i> Incluir Brigadista</button>
                                            </div>
                                        </div>
                                                ...
                                                <table class="table table-hover table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $sql = "SELECT T.descricao, COUNT(T.id) AS qtd
                                                                ...
                                                                INNER JOIN rh_brigada_tipo_ocorrencia T ON T.id = A.tipo_ocorrencia
                        ...
                        <div class="tab-pane container fade" id="menuReunioes">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <div class="clearfix">
                                            <div class="float-start h5">Reuniões da Brigada</div>
                                            <div class="float-end">
                        ...
                        <div class="tab-pane container fade" id="menuAcoes">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <div class="clearfix">
                                            <div class="float-start h5">Ações da Brigada</div>
                                            <div class="float-end">
                        ...
                        <div class="tab-pane container fade" id="menuDocs">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="clearfix">
                                        <div class="float-start h5">Documentos da Brigada</div>
                                        <div class="float-end">
    ...
    <div class="modal fade" id="modalEditarMembro" tabindex="-1" aria-labelledby="altMembroModalLabel" data-bs-backdrop="static">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header">
                    <h5 class="modal-title" id="altMembroModalLabel">ALTERAÇÃO de Membro de Brigada</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                    ...
                    <form id="formAltMembro" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="row mb-2">
                                    <div class="col-sm-6">
                                        <label for="dtInicio" class="form-label cab">Início na Brigada</label>
                                        <input type="date" id="dtInicio" name="dtInicio" class="form-control text-center obrigatorio" required>
                                    </div>
                                    <div class="col-sm-6">
                                        <label for="dtFinal" class="form-label cab">Final</label>
            ...
            <div class="modal-content">
                <form id="formIncAtendimento">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title" id="tituloModalAtendimento">Registrar Atendimento | Ocorrência</h5>
                    ...
                    <div class="modal-body">
                        <div class="row mb-2">
                            <div class="col-md-4">
                                ...
                                <input type="datetime-local" class="form-control" id="data_ocorrencia" name="data_ocorrencia" required value='<?= date('Y-m-d H:i') ?>'>
                            </div>

                            <div class="col-md-8">
                                <label for="brigadistas" class="form-label cab">Brigadistas participantes</label>
                                <div class="input-group mb-3">
                                    <?= seletor_membros_reuniao() ?>
                                    <button type='button' class="btn btn-primary" onclick="addBrigadista('#formIncAtendimento')"><i class="fa-solid fa-person-circle-plus"></i> Adicionar</button>
                                </div>
                ...
                <form id="formAltAtendimento">
                    ...
                    <div class="modal-body">
                        <div class="row mb-2">
                            ...
                            <div class="col-md-8">
                                <label class="form-label">Brigadistas que atenderam:</label>
                                <div class="card">
                                    <div class="card-body">
                                        <div class="input-group mb-3">
                                            <?= seletor_membros_reuniao() ?>
                                            <button type='button' class="btn btn-primary" onclick="addBrigadista('#formAltAtendimento')"><i class="fa-solid fa-person-circle-plus"></i> Adicionar</button>
                                        </div>
                                        <div id="brigadistasContainer" class="d-flex flex-wrap gap-2"></div>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <form id="formNovoTipoOcorrencia">
                <div class="modal-content" style="background-color: gainsboro; width: 500px;">
                    ...
                    <div class="modal-footer" id='botoesNovoTipoOcorrencia'>
                        <button type="button" class="btn btn-success" onclick='btnSalvarTipo()'>Salvar</button>
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                    </div>
                </div>
            </form>
            <div class="text-center h5" id='msgIncTipo'></div>
        </div>
    </div>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="input-group mb-3">
                                            <?= seletor_membros_reuniao() ?>
                                            <button type='button' class="btn btn-primary" onclick="addBrigadista('#formIncReuniao')"><i class="fa-solid fa-person-circle-plus"></i> Adicionar</button>
                                            <button type='button' class="btn btn-secondary" onclick="addTodosBrigadista('#formIncReuniao')"><i class="fa-solid fa-users"></i> Todos</button>
                                        </div>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="input-group mb-3">
                                            <?= seletor_membros_reuniao() ?>
                                            <button type='button' class="btn btn-primary" onclick="addBrigadista('#formAltReuniao')"><i class="fa-solid fa-person-circle-plus"></i> Adicionar</button>
                                            <button type='button' class="btn btn-secondary" onclick="addTodosBrigadista('#formAltReuniao')"><i class="fa-solid fa-users"></i> Todos</button>
                                        </div>
                ...
                <form id="formIncAcao" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                <label class="form-label">Brigadistas Participantes</label>

                                <div class="card">
                                    <div class="card-body">
                                        <div class="input-group mb-3">
                                            <?= seletor_membros_reuniao() ?>
                                            <button type='button' class="btn btn-primary" onclick="addBrigadista('#formIncAcao')"><i class="fa-solid fa-person-circle-plus"></i> Adicionar</button>
                                            <button type='button' class="btn btn-secondary" onclick="addTodosBrigadista('#formIncAcao')"><i class="fa-solid fa-users"></i> Todos</button>
                                        </div>
                                        <div id="brigadistasContainer" class="d-flex flex-wrap gap-2"></div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="input-group mb-3">
                                            <?= seletor_membros_reuniao() ?>
                                            <button type='button' class="btn btn-primary" onclick="addBrigadista('#formAltAcao')"><i class="fa-solid fa-person-circle-plus"></i> Adicionar</button>
                                            <button type='button' class="btn btn-secondary" onclick="addTodosBrigadista('#formAltAcao')"><i class="fa-solid fa-users"></i> Todos</button>
                                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title" id="incUsuarioModalLabel">
                        <h5>Inclusão de Usuário do Módulo: Brigada</h5>
                    </h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <!-- Modal body -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title" id="altUsuarioModalLabel">
                        <h5>Alteração de Usuário do Módulo: Brigada</h5>
                    </h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <!-- Modal body -->
...
{
    global $conn;
    $consulta = "SELECT * from rh_brigada_tipo_ocorrencia order by descricao";
    $stmt = $conn->prepare($consulta);
    $stmt->execute();

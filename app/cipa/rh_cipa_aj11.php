<?PHP
//
//- rh_cipa_aj11.php | Salva ALTERAÇÃO de Atendimento
// (C)haia, 24/06/2025
...
/*
 rh_cipa_aj11.php | 2025-06-24 15:52:30 
{
    "idMembro": "9",
...
$sql = "UPDATE rh_cipa_atendimentos SET 
            idSubSede        = :idSubSede,
...
if ( $stmt->execute()) {
    // Log de criação
    f_log("ALT", "Alterou atendimento de CIPA | Antes:($dadosAntes) | Novos:($stringDados)", "rh_atendimento", $idModulo, $idAtendimento);
    $retorno = [
        "status" => true,

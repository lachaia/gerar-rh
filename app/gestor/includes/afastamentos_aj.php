<?php
// afastramentos_aj.php | Grid de Consulta dos Afastamentos
...
$pesquisa = "SELECT A.*,  P.nome, T.descricao, A.id as idAfastamento
...
while ($linha = $stmt->fetch(PDO::FETCH_ASSOC)) {
    ...
    $dado = array();
    //
    $acoes =   "<a href='#!' class='btn btn-outline-primary btn-sm' onClick='f_visualizar($idAfastamento)'><i class='fa-solid fa-magnifying-glass'></i></a>"; 
    //
    $dsStatus = '';
    if( $status == 'Gestor' ){

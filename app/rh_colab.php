<?php
//
// - rh_colab.php  -  Grade de manutenção dos COLABORADORES (Inclui, Altera, Exclui, Conculta)
// - (C) Chaia, 20/03/2025
//
...
<body class="sb-nav-fixed">
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center bg-dark text-white mt-2 h4">
                            <div class="d-flex">
                                <i class="fa-regular fa-address-book"></i>&nbsp; Cadastro de COLABORADORES
                            </div>
                            <a href='rh_colab_inc.php' class="btn btn-outline-success btn-sm">Incluir</a>
                        </div>
                        <div class="card-body">
                            <div id="msgAlert"></div>
                            <table id="example" class="table table-striped table-hover table-bordered table-sm w-100 nowrap" style="width:100%">
                                <thead>
                                    <tr class="bg-secondary">
                                        ...
                                        <th><sup>2</sup>Matrícula</th>
                                        <th><sup>3</sup>Órgão</th>
                                        <th><sup>4</sup>Função</th>
                                        <th><sup>5</sup>Tp Ctr</th>
                                        <th><sup>6</sup>Admissão</th>
                                        <th><sup>7</sup>Status</th>
                                        <th><sup>8</sup>Lider?</th>
                                        <th><sup>9</sup><i class="fa-solid fa-people-group"></i> Dep</th>
                                        <th style='width: 100px; color: white'><sup>6</sup>Ações</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
    ...
    <script src="js/rh_colab.js"></script>

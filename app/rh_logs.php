...
<head>
    ...
    <link href="css/rh_logs.css" rel="stylesheet" />
...
<body class="sb-nav-fixed">
            ...
            <main>
                <div class="container-fluid px-4">
                    <div class="card mt-2 bg-dark text-white">
                        <h4 class="m-4">
                            <i class="fa-solid fa-person-circle-exclamation"></i> Logs
                        </h4>
                    </div>
                    <div class="card mb-4">
                        <div class="card-header clearfix">
                            ...
                            <div class="float-end d-flex" id='seletores'>
                        ...
                        <div class="card-body">
                            <table id="example" class="table table-striped table-hover table-bordered table-sm fb-8" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Usuario</th>
    ...
    <script src="js/rh_logs.js"></script>
</body>
